...
export const ExtractedDataScreenPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ownerName: 'Rameshwar Mahadev Patil',
    surveyNumber: '142/A',
    subDivision: '1',
    areaHectares: '1.4500',
    landType: 'Agricultural (Jirayat)',
    encumbranceDetails: 'State Bank of India Agricultural Loan Rs. 4,50,000',
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <Card className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="block text-xs font-semibold text-slate-700">Khatauni Khata Number</label>
